...
IMUInternalWrapper::IMUInternalWrapper() {
    this->numberOfSensors = 3;
    this->sensorList[0] = {sensingType::accelerometer, true};
    this->sensorList[1] = {sensingType::gyro, true};
    this->sensorList[2] = {sensingType::temperature, true};
}

void IMUInternalWrapper::gatherAndAccumulate(DataLogger& dataLogger, MeasurementData& data, uint64_t msSinceStart) {
